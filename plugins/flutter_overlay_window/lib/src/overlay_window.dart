...
class FlutterOverlayWindow {
  ...
  /// Launch the main activity from the overlay.
  ///
  /// [payload] is passed as an extra with key `overlay_payload`.
  static Future<bool?> launchMainActivity(String? payload) async {
    final bool? _res = await _overlayChannel.invokeMethod<bool?>(
      'launchMainActivity',
      {'payload': payload},
    );
